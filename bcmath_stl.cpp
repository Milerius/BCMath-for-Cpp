...
static int
bc_comp(const char *lhs, int lint, int ldot, int lfrac, int lscale, const char *rhs, int rint, int rdot, int rfrac,
        int rscale, int scale)
{
    int llen = ldot - lint;
    int rlen = rdot - rint;
...
static std::string
bc_round(char *lhs, int lint, int ldot, int lfrac, int lscale, int scale, int sign, bool add_trailing_zeroes,
...
static std::string
bc_add_positive(const char *lhs, int lint, int ldot, int lfrac, int lscale, const char *rhs, int rint, int rdot,
...
static std::string
bc_sub_positive(const char *lhs, int lint, int ldot, int lfrac, int lscale, const char *rhs, int rint, int rdot,
                int rfrac, int rscale, int scale, int sign)
{
    int llen = ldot - lint;
    int rlen = rdot - rint;
...
static std::string
bc_mul_positive(const char *lhs, int lint, int ldot, int lfrac, int lscale, const char *rhs, int rint, int rdot,
                int rfrac, int rscale, int scale, int sign)
{
    int llen = ldot - lint;
    int rlen = rdot - rint;
...
static std::string
bc_div_positive(const char *lhs, int lint, int ldot, int lfrac, int lscale, const char *rhs, int rint, int rdot,
                int rfrac, int rscale, int scale, int sign)
{
    int llen = ldot - lint;
    int rlen = rdot - rint;
...
static std::string
bc_add(const char *lhs, int lsign, int lint, int ldot, int lfrac, int lscale, const char *rhs, int rsign, int rint,
       int rdot, int rfrac, int rscale, int scale)
{
    if (lsign > 0 && rsign > 0) {
...
std::string BCMath::bcdiv(const std::string &lhs, const std::string &rhs, int scale)
{
    ...
    return bc_div_positive(lhs.c_str(), lint, ldot, lfrac, lscale, rhs.c_str(), rint, rdot, rfrac, rscale, scale,
                           lsign * rsign);
}
...
std::string BCMath::bcmod(const std::string &lhs, const std::string &rhs)
{
    ...
    if (rdot - rint > 18 || mod == 0) {
        std::cerr << "Second parameter \"" << rhs.c_str()
                  << "\" in function bcmod is not a non zero integer less than 1e18 by absolute value" << std::endl;
        return ZERO;
    }
...
std::string BCMath::bcpow(const std::string &lhs, const std::string &rhs)
{
    ...
    if (rdot - rint > 18 || (rsign < 0 && deg != 0)) {
        std::cerr << "Second parameter \"" << rhs.c_str()
                  << "\" in function bcpow is not a non negative integer less than 1e18" << std::endl;
        return ZERO;
    }
...
std::string BCMath::bcmul(const std::string &lhs, const std::string &rhs, int scale)
{
    ...
    return bc_mul_positive(lhs.c_str(), lint, ldot, lfrac, lscale, rhs.c_str(), rint, rdot, rfrac, rscale, scale,
                           lsign * rsign);
}
...
int BCMath::bccomp(const std::string &lhs, const std::string &rhs, int scale)
{
    ...
    return (1 - 2 * (lsign < 0)) *
           bc_comp(lhs.c_str(), lint, ldot, lfrac, lscale, rhs.c_str(), rint, rdot, rfrac, rscale, scale);
}
